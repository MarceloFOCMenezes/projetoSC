...
class EnderecoController(
    ...
    fun criarEndereco(@RequestBody dto: RequestEnderecoDTO): ResponseEntity<Endereco> {
    ...
    fun atualizarEndereco(@PathVariable id: Int, @RequestBody dto: RequestEnderecoDTO): ResponseEntity<Any> {

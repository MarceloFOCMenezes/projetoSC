...
INSERT INTO usuario (nome, email, telefone, senha, tipo, logado) VALUES
('João Silva', 'joao.silva@email.com', '11987654321', 'senha123', 1, false),
('Maria Oliveira', 'maria.oliveira@outroemail.com', '21998765432', 'minhasenha', 0, false),
('Carlos Pereira', 'carlos.pereira@maisum.net', '31976543210', 'seguranca456', 2, false),
('Ana Souza', 'ana.souza@testmail.org', '41965432109', 'aninha123', 1, false),
('Pedro Rodrigues', 'pedro.rodrigues@final.com.br', '51954321098', 'pedrinho789', 0, false);
